...
sample_text_list[1] = " 최근 일어난 이슈 중 가장 기억나는 것 혹은 관심있는 것에 대해 말해보세요.";
sample_text_list[2] =
  "당신이 상사이고 팀원 중 한 명을 해고해야 한다면, 어떻게 해고할 것인가요?";
sample_text_list[3] = "본인을 잘 나타낼 수 있도록 자기소개 해보세요.";
sample_text_list[4] =
  "지금까지 살아오면서 가장 잘한 선택과 후회하는 선택은 무엇인가요? ";
sample_text_list[5] = "직장 내 세대차이로 인한 문제는 어떤 것이 있고, 이를 어떻게 극복할 수 있을지 말해보세요.";
sample_text_list[6] = "본인에게 있는 안좋은 습관과 좋은 습관에 대해 말해보세요."
sample_text_list[7] =
...
input_video_list[1] = "human_video/mid3.mp4";
input_video_list[2] = "human_video/high2.mp4";
//B
input_video_list[3] = "ai_video/ai_low_2.mp4";
input_video_list[4] = "ai_video/ai_mid_1.mp4";
input_video_list[5] = "ai_video/ai_high_1.mp4";
//C
...
input_video_list[10] = "ai_video/ai_mid_2.mp4";
input_video_list[11] = "ai_video/ai_high_4.mp4";

const voice_list = [];
//A
voice_list[0] = "audio/low1.mp3";
voice_list[1] = "audio/mid3.mp3";
voice_list[2] = "audio/high2.mp3";
//B
voice_list[3] = "audio/low2.mp3";
voice_list[4] = "audio/mid1.mp3";
voice_list[5] = "audio/high1.mp3";
//C
