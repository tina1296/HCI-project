...
sample_text_list[3] = "리더에게 필요한 가장 중요한 자질은 무엇이라고 생각하나요?";
sample_text_list[4] =
  "인생에서 과정과 결과 중 무엇이 더 중요하다고 생각하나요? ";
sample_text_list[5] = "워라밸, 재택근무 등의 직장생활의 문화가 앞으로 어떤 방향으로 발전되어야 한다고 생각하나요?";
...
//B
input_video_list[3] = "ai_video/ai_low_4.mp4";
