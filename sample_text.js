...
sample_text_list[0] = "5년 후의 자신의 모습은 어떤 모습일까요?";
sample_text_list[1] =
  "지금까지 살아오면서 가장 잘한 선택과<br/>후회하는 선택은 무엇인가요? ";
sample_text_list[2] =
  "직장 내 세대차이로 인한 문제는 어떤 것이 있고,<br/>이를 어떻게 극복할 수 있을지 말해보세요. ";

sample_text_list[3] = "본인을 잘 나타낼 수 있도록 자기소개 해보세요.";
sample_text_list[4] =
  "인생에서 과정과 결과 중 무엇이 더 중요하다고 생각하나요?";
sample_text_list[5] =
  "당신이 상사이고 팀원 중 한 명을 해고해야 한다면,<br/>어떻게 해고할 것인가요?";

sample_text_list[6] =
  "본인에게 있는 안좋은 습관과 좋은 습관에 대해 말해보세요. ";
sample_text_list[7] =
  "최근 일어난 이슈 중 가장 기억나는 것<br/>혹은 관심있는 것에 대해 말해보세요.";
sample_text_list[8] =
  "워라밸, 재택근무 등의 직장생활의 문화가<br/>앞으로 어떤 방향으로 발전되어야 한다고 생각하나요?";
sample_text_list[9] =
  "리더에게 필요한 가장 중요한 자질은 무엇이라고 생각하나요?";
sample_text_list[10] = "새로운 조직에 적응했던 경험에 대해 말해보세요";
sample_text_list[11] =
  "기업이 사회적인 환원, 즉 기부를 어느 정도 해야한다고 생각하나요?<br/>기업의 기부에 대한 본인의 생각을 말해보세요.";

const voice_list = [];
voice_list[0] = "audio/low1.mp3";
voice_list[1] = "audio/mid1.mp3";
voice_list[2] = "audio/high1.mp3";
voice_list[3] = "audio/low2.mp3";
voice_list[4] = "audio/mid2.mp3";
voice_list[5] = "audio/high2.mp3";
voice_list[6] = "audio/low3.mp3";
voice_list[7] = "audio/mid3.mp3";
voice_list[8] = "audio/high3.mp3";
voice_list[9] = "audio/low4.mp3";
voice_list[10] = "audio/mid4.mp3";
voice_list[11] = "audio/high4.mp3";
...
human_video_list[0] = "human_video/low1.mp4";
...
//A
input_video_list[0] = "human_video/low1.mp4";
input_video_list[1] = "human_video/mid1.mp4";
input_video_list[2] = "human_video/high1.mp4";
//B
input_video_list[3] = "ai_video/ai_low_2.mp4";
input_video_list[4] = "ai_video/ai_mid_2.mp4";
input_video_list[5] = "ai_video/ai_high_2.mp4";
//C
input_video_list[6] = "human_video/low3.mp4";
input_video_list[7] = "human_video/mid3.mp4";
input_video_list[8] = "human_video/high3.mp4";
//D
input_video_list[9] = "ai_video/ai_low_4.mp4";
input_video_list[10] = "ai_video/ai_mid_4.mp4";
input_video_list[11] = "ai_video/ai_high_4.mp4";
